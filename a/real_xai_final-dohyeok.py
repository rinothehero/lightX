...
def train_epoch(model, dataloader, optimizer, args, device, tokenizer):
    ...
    for batch in dataloader:
        ...
        same = (true_labels == bert_preds) & (mlp_preds == true_labels)
        corr = (bert_preds == true_labels) & (mlp_preds != true_labels)
...
def main():
    ...
    torch.save(state, "./models/mlp_xai_agnews_manualIG-dohyeok.pt")
